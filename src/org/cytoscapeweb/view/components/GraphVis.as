...
package org.cytoscapeweb.view.components {
    ...
    import org.cytoscapeweb.view.layout.SBGNPDLayout;
    ...
    public class GraphVis extends Visualization {
        ...
        public function applyLayout(layoutObj:Object):Transition {
            ...
            if (_layoutName === Layouts.PRESET || _layoutName === Layouts.COSE || _layoutName === Layouts.SBGNPD ) {
        ...
        private function createLayout(obj:Object,
            ...
            if (name === Layouts.FORCE_DIRECTED) {
                ...
                // set current layout
                layout = cose;
            } else if (name === Layouts.SBGNPD) {
				// create layout
				var sbgnPD:SBGNPDLayout = new SBGNPDLayout();
				// set layout options
				sbgnPD.setOptions(options);
				// set current layout
				layout = sbgnPD;
			}
        ...
        private function realignGraph():void {
            ...
            for each (var n:NodeSprite in data.nodes) {
				...
				var stateAndInfoGlyphs:Array = n.data.stateAndInfoGlyphs as Array;
